package huce.fit.appreadstories.story.search;
...
public class StorySearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        processEvents();
        rcView();
        storyAdapter.setDataStory(listStory);
    }
    ...
    private void rcView() {
        ...
        storyAdapter = new StoryAdapter((position, view1, isLongClick) -> {
            Intent intent = new Intent(StorySearchActivity.this, StoryInformationActivity.class);
